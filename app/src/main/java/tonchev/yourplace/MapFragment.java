...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-18.142, 178.431), 15));
    }
    ...
    private void updatePlaces() {
        ...
        //execute query
        new MapFragment.GetPlaces().execute(placesSearchStr);
    }
